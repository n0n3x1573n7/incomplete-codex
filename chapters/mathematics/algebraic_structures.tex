...
\begin{document}
	...
	\section{Algebraic Structures}
		...
		\begin{thm}[Dimension Theorem for Linear Transformations]
		...
		\begin{thm}[TFAE for one-to-one linear transformation]
		...
		\begin{thm}[TFAE for linear operator]
		...
		\subsection{Inner Product Space}\label{chap_inner_product_space}
			...
			\begin{defn}[Inner Product Space Isomorphism]
